...
//		assertEquals(carro1.getValorAvaliadoDoBem(), pesquisa.getValorAvaliadoDoBem());
//		
//		try {
...
//		
//		assertEquals(13500, locadora.pesquisar("X-911").getValorAvaliadoDoBem(), 0.01);
//		assertEquals(16000, locadora.pesquisar("A-100").getValorAvaliadoDoBem(), 0.01);
//		assertEquals(28500, locadora.pesquisar("S-123").getValorAvaliadoDoBem(), 0.01);
//		assertEquals(25500, locadora.pesquisar("I-412").getValorAvaliadoDoBem(), 0.01);
//		
//		locadora.depreciarVeiculos(0, 0.1);		// Depreciando todos veículos em 10%
//		
//		assertEquals(12150, locadora.pesquisar("X-911").getValorAvaliadoDoBem(), 0.01);
//		assertEquals(14400, locadora.pesquisar("A-100").getValorAvaliadoDoBem(), 0.01);
//	}
//	
//	@Test
